        ...
        <div class="row align-items-center">
            <div class="col">
                <h5 class="card-title mb-0 text-dark fw-semibold">
                    <i class="bi bi-people-fill text-primary me-2"></i>Course Records
                </h5>
            </div>
            <div class="col-auto">
                        ...
                        <tr class="border-0" style="border-bottom: 1px solid #f8f9fa;">
                            ...
                            <td class=" py-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="fw-medium text-dark">{{ $course->name }}</span>
                                </div>
                            </td>
                            <td class=" py-3 ">{{ number_format($course->cost, 2) }}</td>
                        ...
                        <tr>
                            <td colspan="6" class="text-center py-5">
                                <div class="text-muted">
                                    ...
                                    <p class="mb-3">Get started by adding your first course to the system.</p>
